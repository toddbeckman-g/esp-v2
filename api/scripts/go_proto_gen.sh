...
# HTTP filter common
bazelisk build //api/envoy/http/common:base_go_proto
...
bazelisk build //api/envoy/http/service_control:config_go_proto
...
bazelisk build //api/envoy/http/path_matcher:config_go_proto
...
bazelisk build //api/envoy/http/backend_auth:config_go_proto
...
bazelisk build //api/envoy/http/backend_routing:config_go_proto
